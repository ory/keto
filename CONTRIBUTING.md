...
Ory Keto, please responsibly disclose by contacting us at security@ory.sh.
...
that your contribution won't clash or be obviated by Ory Keto's normal direction. A great way to do this is via
...
- **Helping with open issues.** We have a lot of open issues for Ory Keto and some of them may lack necessary information, some
...
[docs](https://github.com/ory/keto/tree/master/docs) folder. Generate API and configuration reference documentation using
`cd docs; npm run gen`.

For further instructions please head over to [docs/README.md](https://github.com/ory/keto/blob/master/README.md).
...
- Private harassment is also unacceptable. No matter who you are, if you feel you have been or are being harassed or made
  uncomfortable by a community member, please contact one of the channel ops or a member of the Ory Keto core team immediately.
