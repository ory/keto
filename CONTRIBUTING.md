...
# Contribute to Ory Keto<!-- omit in toc -->
...
If you believe you have found a security issue in Ory Keto, please disclose it
...
1. Open a [Discussion](https://github.com/ory/keto/discussions/new/choose) or
   [Issue](https://github.com/ory/keto/issues/new/choose) describing the problem
...
maintain the quality and reliability of Ory Keto, please follow these
guidelines:
