...
func RegisterSyntaxServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SyntaxServiceServer) error {
	mux.Handle(http.MethodPost, pattern_SyntaxService_Check_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
// "SyntaxServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
