...
const file_ory_keto_relation_tuples_v1alpha2_namespaces_service_proto_rawDesc = "" +
	"\n" +
	":ory/keto/relation_tuples/v1alpha2/namespaces_service.proto\x12!ory.keto.relation_tuples.v1alpha2\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x17\n" +
	...
	"namespaces\"\x1f\n" +
	"\tNamespace\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name2\x88\x03\n" +
	"\x11NamespacesService\x12\xf2\x02\n" +
	"\x0eListNamespaces\x128.ory.keto.relation_tuples.v1alpha2.ListNamespacesRequest\x1a9.ory.keto.relation_tuples.v1alpha2.ListNamespacesResponse\"\xea\x01\x92A\xd3\x01\n" +
	"\frelationship*\x1alistRelationshipNamespacesJ\xa6\x01\n" +
	"\x03200\x12\x9e\x01\n" +
	"\x17The list of namespaces.\x12=\n" +
	";\x1a9.ory.keto.relation_tuples.v1alpha2.ListNamespacesResponse\"D\n" +
	"\x10application/json\x120{ \"namespaces\": [ { \"name\": \"my namespace\" } ] }\x82\xd3\xe4\x93\x02\r\x12\v/namespacesB\xc7\x01\n" +
