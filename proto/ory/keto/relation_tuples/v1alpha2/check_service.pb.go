...
type CheckRequest struct {
	...
	Query   *RelationQuery `protobuf:"bytes,8,opt,name=query,proto3" json:"query,omitempty"`
...
func (x *CheckRequest) GetQuery() *RelationQuery {
	if x != nil {
		return x.Query
	}
	return nil
...
var file_ory_keto_relation_tuples_v1alpha2_check_service_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x72, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x6f, 0x72,
	...
	0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x05, 0x71,
	0x75, 0x65, 0x72, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x18, 0x05,
...
var file_ory_keto_relation_tuples_v1alpha2_check_service_proto_depIdxs = []int32{
	...
	3, // 1: ory.keto.relation_tuples.v1alpha2.CheckRequest.query:type_name -> ory.keto.relation_tuples.v1alpha2.RelationQuery
