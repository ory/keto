...
const file_ory_keto_relation_tuples_v1alpha2_read_service_proto_rawDesc = "" +
	"\n" +
	"4ory/keto/relation_tuples/v1alpha2/read_service.proto\x12!ory.keto.relation_tuples.v1alpha2\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/api/visibility.proto\x1a google/protobuf/field_mask.proto\x1a7ory/keto/relation_tuples/v1alpha2/relation_tuples.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xc7\x06\n" +
	"\x19ListRelationTuplesRequest\x12n\n" +
	"\x05query\x18\x01 \x01(\v2B.ory.keto.relation_tuples.v1alpha2.ListRelationTuplesRequest.QueryB\x14\xfa\xd2\xe4\x93\x02\f\x12\n" +
	"NO_SWAGGER\x18\x01R\x05query\x12k\n" +
	"\x0erelation_query\x18\x06 \x01(\v20.ory.keto.relation_tuples.v1alpha2.RelationQueryB\x12\xfa\xd2\xe4\x93\x02\f\x12\n" +
	"NO_SWAGGERR\rrelationQuery\x12O\n" +
	"\vexpand_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x12\xfa\xd2\xe4\x93\x02\f\x12\n" +
	"NO_SWAGGERR\n" +
	"expandMask\x120\n" +
	...
	"page_token\x12 \n" +
	"\tnamespace\x18\a \x01(\tB\x02\x18\x01R\tnamespace\x12\x1a\n" +
	"\x06object\x18\b \x01(\tB\x02\x18\x01R\x06object\x12\x1e\n" +
	"\brelation\x18\t \x01(\tB\x02\x18\x01R\brelation\x12 \n" +
	"\n" +
	"subject_id\x18\n" +
	" \x01(\tH\x00R\n" +
	"subject_id\x12V\n" +
	"\vsubject_set\x18\v \x01(\v22.ory.keto.relation_tuples.v1alpha2.SubjectSetQueryH\x00R\vsubject_set\x1a\x9f\x01\n" +
	"\x05Query\x12\x1c\n" +
	...
	"\x10rest_api_subject\"\xa2\x01\n" +
	"\x1aListRelationTuplesResponse\x12Z\n" +
	"\x0frelation_tuples\x18\x01 \x03(\v20.ory.keto.relation_tuples.v1alpha2.RelationTupleR\x0frelation_tuples\x12(\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\x0fnext_page_token2\xc8\x02\n" +
	"\vReadService\x12\xb8\x02\n" +
	"\x12ListRelationTuples\x12<.ory.keto.relation_tuples.v1alpha2.ListRelationTuplesRequest\x1a=.ory.keto.relation_tuples.v1alpha2.ListRelationTuplesResponse\"\xa4\x01\x92A\x88\x01\n" +
	"\frelationship*\x10getRelationshipsJf\n" +
	"\x03200\x12_\n" +
	"\x1aThe list of relationships.\x12A\n" +
	"?\x1a=.ory.keto.relation_tuples.v1alpha2.ListRelationTuplesResponse\x82\xd3\xe4\x93\x02\x12\x12\x10/relation-tuplesB\xc1\x01\n" +
