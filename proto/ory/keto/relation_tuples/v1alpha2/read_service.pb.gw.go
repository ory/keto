...
func RegisterReadServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ReadServiceServer) error {
	...
	mux.Handle("GET", pattern_ReadService_ListRelationTuples_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/ory.keto.relation_tuples.v1alpha2.ReadService/ListRelationTuples", runtime.WithHTTPPathPattern("/v1alpha2/relation-tuples"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ReadService_ListRelationTuples_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_ReadService_ListRelationTuples_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterReadServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ReadServiceClient) error {
	...
	mux.Handle("GET", pattern_ReadService_ListRelationTuples_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/ory.keto.relation_tuples.v1alpha2.ReadService/ListRelationTuples", runtime.WithHTTPPathPattern("/v1alpha2/relation-tuples"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ReadService_ListRelationTuples_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ReadService_ListRelationTuples_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1alpha2", "relation-tuples"}, ""))
)
