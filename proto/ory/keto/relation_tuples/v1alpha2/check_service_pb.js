...
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.ory.keto.relation_tuples.v1alpha2.CheckResponse.toObject, includeInstance)
  };
...
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.ory.keto.relation_tuples.v1alpha2.CheckResponse;
      reader.readMessage(value,proto.ory.keto.relation_tuples.v1alpha2.CheckResponse.deserializeBinaryFromReader);
...
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.ory.keto.relation_tuples.v1alpha2.CheckResponse.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.ory.keto.relation_tuples.v1alpha2.CheckResponse>}
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckResponse.prototype.getResultsList = function() {
  return /** @type{!Array<!proto.ory.keto.relation_tuples.v1alpha2.CheckResponse>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.ory.keto.relation_tuples.v1alpha2.CheckResponse, 1));
};


/**
 * @param {!Array<!proto.ory.keto.relation_tuples.v1alpha2.CheckResponse>} value
...
/**
 * @param {!proto.ory.keto.relation_tuples.v1alpha2.CheckResponse=} opt_value
 * @param {number=} opt_index
 * @return {!proto.ory.keto.relation_tuples.v1alpha2.CheckResponse}
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckResponse.prototype.addResults = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.ory.keto.relation_tuples.v1alpha2.CheckResponse, opt_index);
};
