...
goog.exportSymbol('proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody', null, global);
 ...
 * @constructor
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.repeatedFields_, null);
};
goog.inherits(proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.displayName = 'proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.prototype.toObject = function(opt_includeInstance) {
  return proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody}
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody;
  return proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody}
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.prototype.getTuplesList = function() {
 ...
 * @return {!proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody} returns this
*/
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.prototype.setTuplesList = function(value) {
 ...
 * @return {!proto.ory.keto.relation_tuples.v1alpha2.RelationTuple}
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.prototype.addTuples = function(opt_value, opt_index) {
 ...
 * @return {!proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody} returns this
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.prototype.clearTuplesList = function() {
...
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 5:
      var value = new proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody;
      reader.readMessage(value,proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.deserializeBinaryFromReader);
      msg.setRestBody(value);
      break;
    case 2:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setLatest(value);
...
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getRestBody();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody.serializeBinaryToWriter
    );
  }
  f = message.getLatest();
  if (f) {
...
/**
 * optional BatchCheckRequestBody rest_body = 5;
 * @return {?proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody}
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequest.prototype.getRestBody = function() {
  return /** @type{?proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody} */ (
    jspb.Message.getWrapperField(this, proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody, 5));
};


/**
 * @param {?proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequestBody|undefined} value
 * @return {!proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequest} returns this
*/
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequest.prototype.setRestBody = function(value) {
 ...
 * @return {!proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequest} returns this
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequest.prototype.clearRestBody = function() {
  return this.setRestBody(undefined);
};
 ...
 * @return {boolean}
 */
proto.ory.keto.relation_tuples.v1alpha2.BatchCheckRequest.prototype.hasRestBody = function() {
