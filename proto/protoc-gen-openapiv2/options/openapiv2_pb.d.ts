...
export class EnumSchema extends jspb.Message { 
    getDescription(): string;
    setDescription(value: string): EnumSchema;
    getDefault(): string;
    setDefault(value: string): EnumSchema;
    getTitle(): string;
    setTitle(value: string): EnumSchema;
    getRequired(): boolean;
    setRequired(value: boolean): EnumSchema;
    getReadOnly(): boolean;
    setReadOnly(value: boolean): EnumSchema;

    hasExternalDocs(): boolean;
    clearExternalDocs(): void;
    getExternalDocs(): ExternalDocumentation | undefined;
    setExternalDocs(value?: ExternalDocumentation): EnumSchema;
    getExample(): string;
    setExample(value: string): EnumSchema;
    getRef(): string;
    setRef(value: string): EnumSchema;
