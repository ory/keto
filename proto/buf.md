...
| parallelization_factor | [int32](#int32)                                                   | optional | The number of check requests to perform in parallel.<br/><br/>Will default to 5 if not provided. If provided, it must be<br/>a positive integer                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
