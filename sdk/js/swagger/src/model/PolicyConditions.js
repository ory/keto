...
;(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwaggerJsClient.PolicyConditions = factory(
  ...
  /**
   * Constructs a new <code>PolicyConditions</code>.
  ...
  /**
   * Constructs a <code>PolicyConditions</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PolicyConditions} obj Optional instance to populate.
   * @return {module:model/PolicyConditions} The populated <code>PolicyConditions</code> instance.
   */
