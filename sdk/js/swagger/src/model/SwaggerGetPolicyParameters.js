...
;(function(root, factory) {
  ...
  /**
   * Constructs a new <code>SwaggerGetPolicyParameters</code>.
   ...
   * @return {module:model/SwaggerGetPolicyParameters} The populated <code>SwaggerGetPolicyParameters</code> instance.
   */
