...
;(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(
      require('../ApiClient'),
      require('./RemoveOryAccessControlPolicyRoleMembersBody')
    )
  } else {
    ...
    root.SwaggerJsClient.RemoveOryAccessControlPolicyRoleMembers = factory(
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Body')) {
        obj[
          'Body'
        ] = RemoveOryAccessControlPolicyRoleMembersBody.constructFromObject(
          data['Body']
        )
      }
