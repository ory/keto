...
(function(root, factory) {
  ...
  /**
   * The UpsertOryAccessControlPolicyRoleOK model module.
   * @module model/UpsertOryAccessControlPolicyRoleOK
   * @version Latest
   */

  /**
   * Constructs a new <code>UpsertOryAccessControlPolicyRoleOK</code>.
   * oryAccessControlPolicyRole
   * @alias module:model/UpsertOryAccessControlPolicyRoleOK
   * @class
   */
  ...
  /**
   * Constructs a <code>UpsertOryAccessControlPolicyRoleOK</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpsertOryAccessControlPolicyRoleOK} obj Optional instance to populate.
   * @return {module:model/UpsertOryAccessControlPolicyRoleOK} The populated <code>UpsertOryAccessControlPolicyRoleOK</code> instance.
   */
