...
;(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwaggerJsClient.WardenOAuth2AccessTokenAuthorizationResponse = factory(
  ...
  /**
   * The WardenOAuth2AccessTokenAuthorizationResponse model module.
   * @module model/WardenOAuth2AccessTokenAuthorizationResponse
   * @version Latest
   */

  /**
   * Constructs a new <code>WardenOAuth2AccessTokenAuthorizationResponse</code>.
   * @alias module:model/WardenOAuth2AccessTokenAuthorizationResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>WardenOAuth2AccessTokenAuthorizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WardenOAuth2AccessTokenAuthorizationResponse} obj Optional instance to populate.
   * @return {module:model/WardenOAuth2AccessTokenAuthorizationResponse} The populated <code>WardenOAuth2AccessTokenAuthorizationResponse</code> instance.
   */
