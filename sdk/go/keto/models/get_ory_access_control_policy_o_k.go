...
// GetOryAccessControlPolicyOK GetOryAccessControlPolicyOK GetOryAccessControlPolicyOK handles this case with default header values.
//
...
func (m *GetOryAccessControlPolicyOK) validatePayload(formats strfmt.Registry) error {
...
func (m *GetOryAccessControlPolicyOK) UnmarshalBinary(b []byte) error {
	var res GetOryAccessControlPolicyOK
