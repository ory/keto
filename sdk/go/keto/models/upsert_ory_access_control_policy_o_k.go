...
// UpsertOryAccessControlPolicyOK UpsertOryAccessControlPolicyOK UpsertOryAccessControlPolicyOK handles this case with default header values.
//
...
func (m *UpsertOryAccessControlPolicyOK) validatePayload(formats strfmt.Registry) error {
...
func (m *UpsertOryAccessControlPolicyOK) UnmarshalBinary(b []byte) error {
	var res UpsertOryAccessControlPolicyOK
