...
// ListOryAccessControlPolicyRolesInternalServerError ListOryAccessControlPolicyRolesInternalServerError ListOryAccessControlPolicyRolesInternalServerError handles this case with default header values.
//
...
func (m *ListOryAccessControlPolicyRolesInternalServerError) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListOryAccessControlPolicyRolesInternalServerError) validatePayload(formats strfmt.Registry) error {
...
func (m *ListOryAccessControlPolicyRolesInternalServerError) UnmarshalBinary(b []byte) error {
	var res ListOryAccessControlPolicyRolesInternalServerError
