...
func (m *ListOryAccessControlPolicyRoles) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListOryAccessControlPolicyRoles) validateFlavor(formats strfmt.Registry) error {
...
func (m *ListOryAccessControlPolicyRoles) UnmarshalBinary(b []byte) error {
	var res ListOryAccessControlPolicyRoles
