...
func (m *GetOryAccessControlPolicyNotFound) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetOryAccessControlPolicyNotFound) validatePayload(formats strfmt.Registry) error {
...
func (m *GetOryAccessControlPolicyNotFound) UnmarshalBinary(b []byte) error {
	var res GetOryAccessControlPolicyNotFound
