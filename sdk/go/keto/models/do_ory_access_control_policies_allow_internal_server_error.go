...
// DoOryAccessControlPoliciesAllowInternalServerError DoOryAccessControlPoliciesAllowInternalServerError DoOryAccessControlPoliciesAllowInternalServerError handles this case with default header values.
//
...
func (m *DoOryAccessControlPoliciesAllowInternalServerError) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DoOryAccessControlPoliciesAllowInternalServerError) validatePayload(formats strfmt.Registry) error {
...
func (m *DoOryAccessControlPoliciesAllowInternalServerError) UnmarshalBinary(b []byte) error {
	var res DoOryAccessControlPoliciesAllowInternalServerError
