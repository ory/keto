...
func (m *UpsertOryAccessControlPolicyRole) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpsertOryAccessControlPolicyRole) validateBody(formats strfmt.Registry) error {
...
func (m *UpsertOryAccessControlPolicyRole) validateFlavor(formats strfmt.Registry) error {
...
func (m *UpsertOryAccessControlPolicyRole) UnmarshalBinary(b []byte) error {
	var res UpsertOryAccessControlPolicyRole
