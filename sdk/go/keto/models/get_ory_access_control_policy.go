...
// GetOryAccessControlPolicy GetOryAccessControlPolicy GetOryAccessControlPolicy get ory access control policy
...
func (m *GetOryAccessControlPolicy) validateFlavor(formats strfmt.Registry) error {
...
func (m *GetOryAccessControlPolicy) validateID(formats strfmt.Registry) error {
...
func (m *GetOryAccessControlPolicy) UnmarshalBinary(b []byte) error {
	var res GetOryAccessControlPolicy
