...
// GetOryAccessControlPolicyRoleNotFound GetOryAccessControlPolicyRoleNotFound GetOryAccessControlPolicyRoleNotFound handles this case with default header values.
//
...
func (m *GetOryAccessControlPolicyRoleNotFound) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetOryAccessControlPolicyRoleNotFound) validatePayload(formats strfmt.Registry) error {
...
func (m *GetOryAccessControlPolicyRoleNotFound) UnmarshalBinary(b []byte) error {
	var res GetOryAccessControlPolicyRoleNotFound
