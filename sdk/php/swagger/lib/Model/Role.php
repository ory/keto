 ...
 *
 * @category    Class
 * @description Role Role Role Role Role Role Role represents a group of users that share the same role. A role could be an administrator, a moderator, a regular user or some other sort of role.
 * @package     keto\SDK
...
class Role implements ArrayAccess
{
    ...
    /**
     * Sets id
     * @param string $id ID is the role's unique id.
     * @return $this
     */
    ...
    /**
     * Sets members
     * @param string[] $members Members is who belongs to the role.
     * @return $this
     */
