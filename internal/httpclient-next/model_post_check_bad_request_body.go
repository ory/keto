...
// PostCheckBadRequestBody PostCheckBadRequestBody PostCheckBadRequestBody PostCheckBadRequestBody PostCheckBadRequestBody PostCheckBadRequestBody PostCheckBadRequestBody PostCheckBadRequestBody PostCheckBadRequestBody post check bad request body
...
func (o PostCheckBadRequestBody) MarshalJSON() ([]byte, error) {
...
type NullablePostCheckBadRequestBody struct {
	value *PostCheckBadRequestBody
	isSet bool
}

func (v NullablePostCheckBadRequestBody) Get() *PostCheckBadRequestBody {
	return v.value
}

func (v *NullablePostCheckBadRequestBody) Set(val *PostCheckBadRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCheckBadRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCheckBadRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCheckBadRequestBody(val *PostCheckBadRequestBody) *NullablePostCheckBadRequestBody {
	return &NullablePostCheckBadRequestBody{value: val, isSet: true}
}

func (v NullablePostCheckBadRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCheckBadRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
