...
// ExpandTree IMPORTANT: We need a manual instantiation of the generic Tree[T] for the OpenAPI spec, since go-swagger does not understand generics :(. This can be fixed by using grpc-gateway.
