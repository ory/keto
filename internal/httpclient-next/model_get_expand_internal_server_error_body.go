...
// GetExpandInternalServerErrorBody GetExpandInternalServerErrorBody GetExpandInternalServerErrorBody GetExpandInternalServerErrorBody GetExpandInternalServerErrorBody GetExpandInternalServerErrorBody GetExpandInternalServerErrorBody get expand internal server error body
...
func NewGetExpandInternalServerErrorBody() *GetExpandInternalServerErrorBody {
	this := GetExpandInternalServerErrorBody{}
	return &this
}
...
func (o GetExpandInternalServerErrorBody) MarshalJSON() ([]byte, error) {
...
type NullableGetExpandInternalServerErrorBody struct {
	value *GetExpandInternalServerErrorBody
	isSet bool
}

func (v NullableGetExpandInternalServerErrorBody) Get() *GetExpandInternalServerErrorBody {
	return v.value
}

func (v *NullableGetExpandInternalServerErrorBody) Set(val *GetExpandInternalServerErrorBody) {
	v.value = val
	v.isSet = true
}

func (v NullableGetExpandInternalServerErrorBody) IsSet() bool {
	return v.isSet
}

func (v *NullableGetExpandInternalServerErrorBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetExpandInternalServerErrorBody(val *GetExpandInternalServerErrorBody) *NullableGetExpandInternalServerErrorBody {
	return &NullableGetExpandInternalServerErrorBody{value: val, isSet: true}
}

func (v NullableGetExpandInternalServerErrorBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetExpandInternalServerErrorBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
