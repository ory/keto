...
// IsInstanceAliveInternalServerErrorBody IsInstanceAliveInternalServerErrorBody IsInstanceAliveInternalServerErrorBody IsInstanceAliveInternalServerErrorBody IsInstanceAliveInternalServerErrorBody IsInstanceAliveInternalServerErrorBody IsInstanceAliveInternalServerErrorBody IsInstanceAliveInternalServerErrorBody IsInstanceAliveInternalServerErrorBody is instance alive internal server error body
...
func NewIsInstanceAliveInternalServerErrorBody() *IsInstanceAliveInternalServerErrorBody {
	this := IsInstanceAliveInternalServerErrorBody{}
	return &this
}
...
func (o IsInstanceAliveInternalServerErrorBody) MarshalJSON() ([]byte, error) {
...
type NullableIsInstanceAliveInternalServerErrorBody struct {
	value *IsInstanceAliveInternalServerErrorBody
	isSet bool
}

func (v NullableIsInstanceAliveInternalServerErrorBody) Get() *IsInstanceAliveInternalServerErrorBody {
	return v.value
}

func (v *NullableIsInstanceAliveInternalServerErrorBody) Set(val *IsInstanceAliveInternalServerErrorBody) {
	v.value = val
	v.isSet = true
}

func (v NullableIsInstanceAliveInternalServerErrorBody) IsSet() bool {
	return v.isSet
}

func (v *NullableIsInstanceAliveInternalServerErrorBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIsInstanceAliveInternalServerErrorBody(val *IsInstanceAliveInternalServerErrorBody) *NullableIsInstanceAliveInternalServerErrorBody {
	return &NullableIsInstanceAliveInternalServerErrorBody{value: val, isSet: true}
}

func (v NullableIsInstanceAliveInternalServerErrorBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIsInstanceAliveInternalServerErrorBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
