...
// GetExpandBadRequestBody GetExpandBadRequestBody GetExpandBadRequestBody GetExpandBadRequestBody GetExpandBadRequestBody GetExpandBadRequestBody GetExpandBadRequestBody get expand bad request body
...
func (o GetExpandBadRequestBody) MarshalJSON() ([]byte, error) {
...
type NullableGetExpandBadRequestBody struct {
	value *GetExpandBadRequestBody
	isSet bool
}

func (v NullableGetExpandBadRequestBody) Get() *GetExpandBadRequestBody {
	return v.value
}

func (v *NullableGetExpandBadRequestBody) Set(val *GetExpandBadRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableGetExpandBadRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableGetExpandBadRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetExpandBadRequestBody(val *GetExpandBadRequestBody) *NullableGetExpandBadRequestBody {
	return &NullableGetExpandBadRequestBody{value: val, isSet: true}
}

func (v NullableGetExpandBadRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetExpandBadRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
