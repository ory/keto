...
func (g *connectClient) queryNamespaces(t require.TestingT) (apiResponse ketoapi.GetNamespacesResponse) {
...
var _ transactClient = (*connectClient)(nil)

func (g *connectClient) conn(t require.TestingT, remote string) *grpc.ClientConn {
...
func (g *connectClient) readConn(t require.TestingT) *grpc.ClientConn {
	if g.rc == nil {
...
func (g *connectClient) writeConn(t require.TestingT) *grpc.ClientConn {
	if g.wc == nil {
...
func (g *connectClient) oplSyntaxConn(t require.TestingT) *grpc.ClientConn {
	if g.oc == nil {
...
func (g *connectClient) createTuple(t require.TestingT, r *ketoapi.RelationTuple) {
	g.transactTuples(t, []*ketoapi.RelationTuple{r}, nil)
}

func (*connectClient) createQuery(q *ketoapi.RelationQuery) *rts.RelationQuery {
...
func (g *connectClient) queryTuple(t require.TestingT, q *ketoapi.RelationQuery, opts ...x.PaginationOptionSetter) *ketoapi.GetResponse {
...
func (g *connectClient) queryTupleErr(t require.TestingT, expected herodot.DefaultError, q *ketoapi.RelationQuery, opts ...x.PaginationOptionSetter) {
	c := rts.NewReadServiceClient(g.readConn(t))
	pagination := x.GetPaginationOptions(opts...)
...
func (g *connectClient) check(t require.TestingT, r *ketoapi.RelationTuple) bool {
	...
	resp, err := c.Check(g.ctx, connect.NewRequest(req))
	require.NoError(t, err)

	return resp.Msg.Allowed
}

func (g *connectClient) expand(t require.TestingT, r *ketoapi.SubjectSet, depth int) *ketoapi.Tree[*ketoapi.RelationTuple] {
...
func (g *connectClient) waitUntilLive(t require.TestingT) {
...
func (g *connectClient) deleteTuple(t require.TestingT, r *ketoapi.RelationTuple) {
	g.transactTuples(t, nil, []*ketoapi.RelationTuple{r})
}

func (g *connectClient) deleteAllTuples(t require.TestingT, q *ketoapi.RelationQuery) {
...
func (g *connectClient) transactTuples(t require.TestingT, ins []*ketoapi.RelationTuple, del []*ketoapi.RelationTuple) {
	c := rts.NewWriteServiceClient(g.writeConn(t))
...
func (g *connectClient) oplCheckSyntax(t require.TestingT, content []byte) (parseErrors []*ketoapi.ParseError) {
