...
func requireInt32WithinBounds(t testing.TB, v int) int32 {
...
func (g *grpcClient) queryTuple(t testing.TB, q *ketoapi.RelationQuery, opts ...paginationOptionSetter) *ketoapi.GetResponse {
