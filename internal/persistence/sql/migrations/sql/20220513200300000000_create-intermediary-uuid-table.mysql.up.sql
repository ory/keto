...
(
    ...
    INDEX                    keto_relation_tuples_uuid_reverse_subject_idx (nid, subject_id, subject_set_namespace_id, subject_set_object, subject_set_relation, relation, namespace_id),
