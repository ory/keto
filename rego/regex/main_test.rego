...
test_allow_group_policy {
    ...
    decide_allow(policies, {"group-subject": ["groups:6"]}) with input as {"resource": "articles:6", "subject": "group-subject", "action": "actions:6"}

    not decide_allow(policies, {"group-subject": ["groups:6"]}) with input as {"resource": "articles:6", "subject": "not-group-subject", "action": "actions:6"}
    not decide_allow(policies, {"group-subject": ["not-groups"]}) with input as {"resource": "articles:6", "subject": "group-subject", "action": "actions:6"}
}
