...
```shell
$ docker pull oryd/keto:v0.7.0-alpha.0.pre.4
$ docker run --rm -it oryd/keto:v0.7.0-alpha.0.pre.4 help
```
...
```shell
$ bash <(curl https://raw.githubusercontent.com/ory/keto/master/install.sh) -b . v0.7.0-alpha.0.pre.4
$ ./keto help
```
...
$ cd keto
$ git checkout v0.7.0-alpha.0.pre.4
$ make install
$ keto help
```
