import CodeTabs from "../../src/theme/CodeExamples/CodeTabs";
---
...
import CodeTabs from '@theme/CodeExamples/CodeTabs'
RelationTuplePrism()
...
This question is
encoded as the following [relation tuple](../concepts/relation-tuples):
...
messages are stored in Ory Keto and access to the cleartext is encoded by the `decypher` relation.

### Directly Defined Access

Ory Keto can know the exact relation tuple that the application is checking. Intuitively,
...
<CodeTabs sampleId="simple-access-check-guide" />
