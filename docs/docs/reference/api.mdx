...
| Name      | Type                      | Required | Restrictions | Description                               |
| --------- | ------------------------- | -------- | ------------ | ----------------------------------------- |
| namespace | string                    | true     | none         | Namespace of the Relation Tuple in: query |
| object    | string                    | true     | none         | Object of the Relation Tuple in: query    |
| relation  | string                    | true     | none         | Relation of the Relation Tuple in: query  |
