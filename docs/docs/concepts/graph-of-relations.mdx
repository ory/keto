...
[implications on performance](../performance.mdx) and [internal algorithms](/TODO).

## Definition

The graph consists of three types of nodes. [Object](./objects.mdx) nodes that
represent application objects, intermediary
[subject set](./subjects#subject-sets.mdx) nodes, and
[subject ID](./subjects#subject-ids.mdx) nodes representing individuals. Edges are
