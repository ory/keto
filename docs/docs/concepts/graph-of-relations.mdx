...
[subject set](./subjects#subject-sets) nodes, and
[subject ID](./subjects#subject-ids) nodes representing individuals. Edges are
directed and represent the relation between an object and subject.
...
This example omits the [namespace](./namespaces) from all data to improve
