...
[subject sets](./subjects.mdx) can cross-reference from one namespace to another.
...
The application can also use namespaces to scope [objects](./objects.mdx) because
