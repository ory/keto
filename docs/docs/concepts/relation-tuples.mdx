...
[namespace](./namespaces.mdx) where its relation has to be defined and configured.
The following
...
The namespace is often omitted in examples for
...
Head over to the [basic full feature example](../examples/olymp-file-sharing.mdx) to
