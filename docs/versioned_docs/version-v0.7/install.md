...
```shell
$ docker pull oryd/keto:v0.7.0-alpha.0.pre.3
$ docker run --rm -it oryd/keto:v0.7.0-alpha.0.pre.3 help
```
...
```shell
$ bash <(curl https://raw.githubusercontent.com/ory/keto/master/install.sh) -b . v0.7.0-alpha.0.pre.3
$ ./keto help
```
...
$ cd keto
$ git checkout v0.7.0-alpha.0.pre.3
$ make install
$ keto help
```
