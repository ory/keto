...
//			RelationTupleDeltas: append(rts.RelationTupleToDeltas(insertTuples, rts.RelationTupleDelta_ACTION_INSERT), rts.RelationTupleToDeltas(deleteTuples, rts.RelationTupleDelta_ACTION_DELETE)...),
//	 })
...
func NewSubjectID(id string) *Subject { return &Subject{Ref: &Subject_Id{Id: id}} }
