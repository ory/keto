...
// UnimplementedReadServiceServer must be embedded to have
...
func (UnimplementedReadServiceServer) ListRelationTuples(context.Context, *ListRelationTuplesRequest) (*ListRelationTuplesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListRelationTuples not implemented")
}
...
func RegisterReadServiceServer(s grpc.ServiceRegistrar, srv ReadServiceServer) {
	// If the following call panics, it indicates UnimplementedReadServiceServer was
