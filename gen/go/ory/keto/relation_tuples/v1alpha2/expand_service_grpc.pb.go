...
// All implementations must embed UnimplementedExpandServiceServer
...
// UnimplementedExpandServiceServer must be embedded to have
...
func (UnimplementedExpandServiceServer) mustEmbedUnimplementedExpandServiceServer() {}
func (UnimplementedExpandServiceServer) testEmbeddedByValue()                       {}
...
func RegisterExpandServiceServer(s grpc.ServiceRegistrar, srv ExpandServiceServer) {
	// If the following call panics, it indicates UnimplementedExpandServiceServer was
...
func _ExpandService_Expand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExpandService_Expand_FullMethodName,
	}
