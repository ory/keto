...
func (c *checkServiceClient) Check(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*CheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/keto.authz.v1.CheckService/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CheckService_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/keto.authz.v1.CheckService/Check",
	}
...
var _CheckService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "keto.authz.v1.CheckService",
	...
	Metadata: "keto/authz/v1/acl_service.proto",
}
...
func (c *readServiceClient) Read(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (*ReadResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/keto.authz.v1.ReadService/Read", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReadService_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/keto.authz.v1.ReadService/Read",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ReadService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "keto.authz.v1.ReadService",
...
func (c *watchServiceClient) Watch(ctx context.Context, in *WatchRequest, opts ...grpc.CallOption) (*WatchResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/keto.authz.v1.WatchService/Watch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WatchService_Watch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/keto.authz.v1.WatchService/Watch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _WatchService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "keto.authz.v1.WatchService",
...
func (c *writeServiceClient) Write(ctx context.Context, in *WriteRequest, opts ...grpc.CallOption) (*WriteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/keto.authz.v1.WriteService/Write", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *writeServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/keto.authz.v1.WriteService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WriteService_Write_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/keto.authz.v1.WriteService/Write",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WriteService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/keto.authz.v1.WriteService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _WriteService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "keto.authz.v1.WriteService",
