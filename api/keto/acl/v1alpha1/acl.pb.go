...
var file_keto_acl_v1alpha1_acl_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x07, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x55, 0x0a, 0x07, 0x53, 0x75,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x10, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x48, 0x00, 0x52, 0x02, 0x69, 0x64, 0x12, 0x31, 0x0a, 0x03, 0x73, 0x65, 0x74, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6b, 0x65, 0x74, 0x6f, 0x2e, 0x61, 0x63, 0x6c, 0x2e,
	...
	0x6e, 0x42, 0x85, 0x01, 0x0a, 0x18, 0x73, 0x68, 0x2e, 0x6f, 0x72, 0x79, 0x2e, 0x6b, 0x65, 0x74,
	0x6f, 0x2e, 0x61, 0x63, 0x6c, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x08,
	0x41, 0x63, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68,
...
var file_keto_acl_v1alpha1_acl_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_keto_acl_v1alpha1_acl_proto_goTypes = []interface{}{
	(*RelationTuple)(nil), // 0: keto.acl.v1alpha1.RelationTuple
	(*Subject)(nil),       // 1: keto.acl.v1alpha1.Subject
	(*SubjectSet)(nil),    // 2: keto.acl.v1alpha1.SubjectSet
}
var file_keto_acl_v1alpha1_acl_proto_depIdxs = []int32{
	1, // 0: keto.acl.v1alpha1.RelationTuple.subject:type_name -> keto.acl.v1alpha1.Subject
	2, // 1: keto.acl.v1alpha1.Subject.set:type_name -> keto.acl.v1alpha1.SubjectSet
...
func file_keto_acl_v1alpha1_acl_proto_init() {
	...
	file_keto_acl_v1alpha1_acl_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*Subject_Id)(nil),
		(*Subject_Set)(nil),
	}
	type x struct{}
