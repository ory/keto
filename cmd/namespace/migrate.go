...
func NewMigrateCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			status, err := d.Registry().NamespaceManager().NamespaceStatus(context.Background(), n.Name)
			if err != nil {
			...
			if err := d.Registry().NamespaceManager().MigrateNamespaceUp(context.Background(), n); err != nil {
